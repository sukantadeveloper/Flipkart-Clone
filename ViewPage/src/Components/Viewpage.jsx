                ...
                {viewData.map((item) => (
                    <Box w="40%" h="100vh" position={"sticky"}>
                        <Box display={"flex"} p="15px">
                            ...
                            <Box w="79%"> <Img m="auto" src={item.image} alt="bigimg" /> </Box>
                 ...
                 {viewData.map((item) => (
                <Box w="60%" h="100vh" overflow="auto" pl="2%">
                    ...
                    <Flex display={"flex"} justifyContent={"space-between"}>
                        <Box>
                            ...
                            <Box display="flex" alignItems={"center"} borderBottom="1px solid #2974F1"> <Input variant='unstyled' placeholder='Enter Delivery pincode' /> Check </Box>
                        </Box>
                        <Box>
