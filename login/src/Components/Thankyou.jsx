        ...
        >
          <Flex>
            ...
            >
              ...
              <GridItem fontSize="15px">Sukanta Gosh</GridItem>

              <Box mt="7px" width="300px">
                <GridItem>
                  54/2 new Lorem ipsum dolor sit Lorem- ipsum dolor sit amet{' '}
                </GridItem>
              </Box>
              <GridItem mt="7px">Phone number 8305588950</GridItem>
              <GridItem mt="10px">This order is tracked by 8305588950</GridItem>
            </Grid>
            <Image
              height="15rem"
