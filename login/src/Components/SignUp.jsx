...
export function Signup() {
  ...
  var flag = false;
    ...
    return (
      <>
        <Button  _hover={{ bg: 'white' }} fontWeight="400" marginBottom="2" bg="white" textAlign="center" onClick={onOpen}>Signup</Button>
        ...
        >
          ...
          <ModalContent>
            ...
            <ToastContainer/>
            <ModalCloseButton size="lg" color="white" marginRight="-3.5rem" marginTop="-4" />
            <div style={{display:"flex"}}>
               <Box height="32rem" bg="#2874f0" width="16rem" padding="35px">
                <Text fontWeight="600" color="white" fontSize='2xl'>Looks like you're new here!</Text>
                 <Text fontWeight="600"  marginTop="15px" color="#Dbdbdb" fontSize='1xl'>Sign up with your email<br /> address to get started</Text>
