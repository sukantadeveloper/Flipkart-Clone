  ...
  return (
    <>
        ...
        >
          <Flex gap="20px">
            ...
            <Box mt="20px">
              ...
              <Text fontWeight="400">
                Your item will be delivered by {FormatDate()}
              </Text>
            </Box>
            <Divider
              marginLeft="24rem"
      ...
      <Box display={["block", "none", "none"]}>
        ...
        <Box display={'flex'} alignItems={'center'} m='5px' justifyContent={'space-around'}>
          ...
          />
          <Box mt="40px" >
            <Text color="#2874f0" fontSize="20px">
              Order placed for ₹{amount}!
            </Text>
            <Text fontWeight="400">
              Your item will be delivered by {FormatDate()}
        ...
        <Flex w={'80%'} m='auto' alignItems={'center'} justifyContent={'space-around'}>
          <Box>
            <Text
        ...
        <NavLink to='/'>
          <Button display='block' colorScheme='teal' w={'50%'} m='auto' mt={'25px'} mb={'25px'}>
            Continue Shopping
