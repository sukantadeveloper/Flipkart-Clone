...
function Footer() {
    return (
        <Box bg='#F1F3F6' border={'1px solid #F1F3F6'}>
            ...
            <Box mt={'1rem'} display={"flex"} bg="rgb(22,34,55)" borderBottom="1px solid grey"  >
                <Box w="58%" >
                ...
                <Box w="42%">
                    <Grid  templateColumns={['repeat(1,1fr)','repeat(2, 1fr)','repeat(2, 1fr)']} gap="15px" color="white" padding={{ base: '20px', md: '30px', lg: '40px' }} fontSize={{ base: '7px', md: '10px', lg: '13px' }}>
                        ...
                        <GridItem>
                            ...
                            <Text display={"flex"} > Telephone : <Text pl="5px" > 044-45614700</Text></Text>
