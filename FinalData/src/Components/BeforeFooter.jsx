...
function BeforeFooter() {
    return (
        <div> <hr />
            <Box p="25px" bg="#FFFFFF" color={"#757171"} borderTop="2px solid silver">
                <Text fontSize={"17px"} pb="9px" fontWeight={"bold"}>    Flipkart: The One-stop Shopping Destination</Text>
                ...
                <Text fontSize={"17px"} pb="9px" fontWeight={"bold"}>
                    Flipkart Plus
                </Text>
