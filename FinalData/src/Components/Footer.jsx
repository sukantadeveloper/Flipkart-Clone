...
function Footer() {
    return (
        <div>
            <Grid templateColumns='repeat(6, 1fr)' bg="rgb(22,34,55)" color="white" padding={{ base: '20px', md: '30px', lg: '40px' }}  fontSize={{ base: '7px', md: '10px', lg: '13px' }}>
            ...
            <Box  x p="20px"  bg="rgb(22,34,55)" display={"flex"} alignItems="center">
                <Box  w="73%">
                    <Grid  templateColumns='repeat(5, 1fr)' color={"white"} fontSize={{ base: '8px', md: '10px', lg: '13px' }}>
                        ...
                        <GridItem> 2007-2022 Flipkart.com</GridItem>
                    </Grid>
                </Box>
                <Box w="28%">
