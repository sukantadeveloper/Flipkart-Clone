...
function Footer() {
    return (
        <div>
            <Grid templateColumns='repeat(6, 1fr)' bg="rgb(22,34,55)" color="white" p="40px" fontSize="13px">
